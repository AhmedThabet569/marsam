...
//edit to make hreo-search rtl mode 
    function checkHeroFeatPosts(){
      setTimeout(function(){
        if(!$(".hero-header .feat-posts").length){
          var hs = $(".hero-search").parent().width();
          if(viewport().width > 767){
              $(".hero-search,.search-categories").stop().animate({width:hs*0.8,right:hs*0.1});
          }
          else{
            $(".hero-search,.search-categories").stop().animate({width:hs*0.9,right:hs*0.05});
          }
        }
      },1000);
    }
    ...
    $("#slide-nav").on("click", toggler, function (e) {
      ...
      if(!selected){
        ...
        if($(".search-popup").css("right")!=="0px"&&$(".login-popup").css("left")!=="0px"&&$(".review-popup").css("left")!=="0px"&&$(".pm-popup").css("left")!=="0px"){
          stopScrolling(0);
        }
    ...
    $("body").on("click",".header-search-button,.search-pop-button", function(e){
      ...
      if(!$(".search-popup").hasClass("showing-search")){
        stopScrolling(1);
        $(".search-popup").addClass("showing-search").css({right:"-100%",zindex:999}).stop().animate({right:0,opacity:1},{duration:500});
        $(".review-popup").stop().animate({right:"-200%",opacity:0.99},{duration:500});
        $(".pm-popup").stop().animate({right:"-200%",opacity:0.99},{duration:500});
        $(".login-popup").css({zIndex:998}).stop().animate({right:"-200%",opacity:0.99},{duration:500});
        setTimeout(function(){
        ...
        stopScrolling(0);
        $(".search-popup").stop().animate({right:"-200%",opacity:0.99},{duration:500});
        setTimeout(function(){
    ...
    $(".quick-menu a").on("click", function(e){
      ...
      if(_.hasClass("pvt")){
        ...
        stopScrolling(1);
        $(".pm-popup").addClass("showing-pm").css({right:"-100%"}).stop().animate({right:0,opacity:1},{duration:500});
      }
      if ($.isFunction($.fn.tooltip)) {
    ...
    $("body").on("click",".write-review a", function(e){
      ...
      e.stopPropagation();
      stopScrolling(1);
      $(".review-popup").addClass("showing-review").css({right:"-100%"}).stop().animate({right:0,opacity:1},{duration:500});
    });
    ...
    $("body").on("click",".user-login,.sign-in", function(e){
      ...
      if(!$(".login-popup").hasClass("showing-login")){
        stopScrolling(1);
        $(".login-popup").addClass("showing-login").css({right:"-100%",zIndex:999}).stop().animate({right:0,opacity:1},{duration:500});
        $(".review-popup").stop().animate({left:"-200%",opacity:0.99},{duration:500});
        $(".pm-popup").stop().animate({left:"-200%",opacity:0.99},{duration:500});
        $(".search-popup").css({zIndex:998}).stop().animate({right:"-200%",opacity:0.99},{duration:500});
        setTimeout(function(){
          $(".search-popup").removeClass("showing-search");
          $(".review-popup").removeClass("showing-review");
          $(".pm-popup").removeClass("showing-pm");
        ...
        stopScrolling(0);
        $(".login-popup").stop().animate({right:"-200%",opacity:0.99},{duration:500});
        setTimeout(function(){
          $(".login-popup").removeClass("showing-login");
        },500);
      }
